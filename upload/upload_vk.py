...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 Valeria Solverde Daily!\n\n#relationships #lifelessons #realtalk"
        ...
        video = upload.video(
            ...
            name=title or 'Valeria Solverde Video',
...
def main():
    ...
    title = sys.argv[3] if len(sys.argv) > 3 else "Valeria Solverde"
